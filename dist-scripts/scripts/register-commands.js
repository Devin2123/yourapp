...
const commands = [
    ...
    new discord_js_1.SlashCommandBuilder()
        ...
        .addStringOption(o => o.setName("chain").setDescription("Chain (e.g., POLYGON, ETH)").setRequired(true))
        .addStringOption(o => o.setName("address").setDescription("Payout wallet address").setRequired(true))
...
async function main() {
    if (DEV_GUILD_ID) {
        ...
        await rest.put(discord_js_1.Routes.applicationGuildCommands(CLIENT_ID, DEV_GUILD_ID), { body: commands });
